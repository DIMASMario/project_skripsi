    ...
    <div class="login-container">
        ...
        <div class="logo-container">
            ...
            <div class="welcome-text">
                ...
                <p>Masuk ke Akun Pelayanan Digital Desa Blanakan</p>
            </div>
        </div>
        ...
        <div class="login-card">
            ...
            <div class="info-box">
                ...
                Gunakan <strong>Email</strong> atau <strong>Nomor HP</strong> untuk login
            </div>
            ...
            <div class="footer-links">
                <a href="<?= base_url('auth/admin-login') ?>">
                    <i class="bi bi-shield"></i> Login sebagai Admin
                </a>
                <a href="<?= base_url() ?>">
